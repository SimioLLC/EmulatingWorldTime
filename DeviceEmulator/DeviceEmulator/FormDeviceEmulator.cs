...
{
    public partial class FormDeviceEmulator : Form
    {

        private DateTime TimeRequestFound { get; set; }

        public FormDeviceEmulator()
        {
            InitializeComponent();
        }
        ...
        private void FormEmulation_Load(object sender, EventArgs e)
        {
            ...
            textFileLocation.Text = Properties.Settings.Default.FolderPath;
        ...
        /// <summary>
        /// Clean up the device emulator files.
        /// </summary>
        private void CleanFolder()
        {
            try
            {
                string[] files = Directory.GetFiles(Properties.Settings.Default.FolderPath, "Request*.txt");
                foreach ( string filepath in files )
                {
                    File.Delete(filepath);
                }

                files = Directory.GetFiles(Properties.Settings.Default.FolderPath, "Response*.txt");
                foreach (string filepath in files)
                {
                    File.Delete(filepath);
                }
        ...
        /// Put out the Response file, and delete the Request file.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void FormDeviceEmulator_FormClosing(object sender, FormClosingEventArgs e)
        {
